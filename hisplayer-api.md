...
* **public List <StreamProperties> multiStreamProperties**: List of properties for multi stream. Please, don't modify this list directly in the code, use the **AddStream** or **RemoveStream** functions instead.
...
* **public class StreamProperties**:
    ...
    * **public bool FlipTextureVertically**: Flip the texture of the stream vertically. This value should be called before **SetUpPlayer**  or **AddStream** functions. This API is not supported for WebGL. Supported Platform: Android.
    ...
    * **public List \<DRM_Token\> DRMTokens**: List of the DRM tokens for each URL. This API is not supported for WebGL. Supported Platforms: [Android](https://hisplayer.github.io/UnityAndroid-SDK/#/), [iOS](https://hisplayer.github.io/UnityiOS-SDK/#/)
